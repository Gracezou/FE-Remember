...
var filterRestaurants = function (restaurants, veganFriendly, maxPrice, maxDistance) {
    if (veganFriendly) {
        restaurants = restaurants.filter(([, , v]) => v)
    }
    restaurants = restaurants.filter(([, , , price, distance]) => price <= maxPrice && distance <= maxDistance)
    restaurants.sort(([id1, r1], [id2, r2]) => r2 - r1 || id2 - id1)
